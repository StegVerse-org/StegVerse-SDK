...
## Post-merge pilot reconciliation — source only

Source-only SDK [PR #322](https://github.com/StegVerse-org/StegVerse-SDK/pull/322) merged as `2e3ad70eb5525a49c91631b1aa2907d5c47be034` after exact head `c0ba527ef557a5d113663bcae4ebbb8592a1c4b4` passed 12/12 applicable checks. This merge adds independent read-only DeepWiki capture, SHA-256 provenance, 38-title review inventory, 613-candidate source-bound link review and unresolved citation/claim evidence scripts, **not** generated page imports. The first exact semantic mismatch is recorded in `docs/deepwiki-review/CITATION_AUDIT.md`: the generated governance-intake diagram cites `README.md:29-30`, which describes Publisher/egress dependencies rather than the diagram's code wiring. Original SDK-PUBLIC-DEVELOPER-WIKI-001 remains historically RETIRED/COMPLETED; optional review under central ECOSYSTEM-OPEN-SOURCE-STRATEGY-001 COSV 20010010100000 remains ACTIVE/CHECKED_OUT. Until all generated claims and rights clear review, retained raw markdown is evidence only. No fresh Pages deployment, new license, terminal runtime event or release is claimed.

## Frozen generated-citation priority review (source-only successor to merged #329)

Existing central owner `ECOSYSTEM-OPEN-SOURCE-STRATEGY-001` / COSV `20010010100000` remains ACTIVE/CHECKED_OUT at the last read canonical Registry generation 243; original developer-wiki goal remains RETIRED/COMPLETED. The current source-only branch `docs/deepwiki-priority-review-20260925` proposes a reproducible `scripts/triage_frozen_deepwiki_citations.py` and tests, plus a newly authored first-party [source guide](docs/deepwiki-review/FIRST_PARTY_SOURCE_GUIDE.md) that does **not** copy generated prose. It retains the original 38-page capture hash `a729d9b0f487f785b0e8f92006f303e8520e3593b6eb6c4c5de43273daa72087` and produces per-citation registers: 75 flagged low lexical-overlap references become 27 narrow source-literal confirmations (larger contexts unapproved), two citation-context mismatches, and 46 larger-claim review cases. All 46 originally empty-link defects remain unapproved for republication even where source proposals exist. Review code explicitly never claims full semantic approval or generated-text reuse permission. Before any merge: exact-head CI and owner review. No new Pages publication, runtime authority, Master Records closure, source release or licensing change is claimed.
...
## 2026-09-25 source-limited semantic review without a new wiki owner

Under existing `ECOSYSTEM-OPEN-SOURCE-STRATEGY-001` COSV `20010010100000`, draft SDK PR #333 reexamines the 538 previously pending links and original 75 prioritized links against the original captured source excerpts and exact offset/predecessor graph. Historical review run 36193980433 retained artifact 10888669315, reporting 613 original candidates assessed; source-evidence categories and per-occurrence context IDs are independently preserved, with zero full generated semantic approvals and unchanged frozen content hash. The next regression also preserves earlier independently verified narrow facts where the newer symbol/fragment heuristic cannot reproduce them, instead of pretending their earlier evidence disappeared. The new [first-party technical contract guide](docs/deepwiki-review/FIRST_PARTY_VERIFIED_CONTRACTS.md) contains 15 selected non-authorizing source facts from pinned newer SDK code and is intentionally outside the existing six-file Pages builder. The [rights record](docs/deepwiki-review/GENERATED_DOCS_AND_DEPENDENCY_RIGHTS.md) distinguishes source MIT from public generated-text owner uncertainty and inaccessible optional exact-pinned dependency LICENSE reads. No duplicate wiki owner, generated-page import, new source release, licensed third-party text, session-origin runtime, Publisher mutation or Master Records closure is asserted. Any actual publication change continues through the existing SDK Pages workflow/owner after applicable source/rights review.

## Historical narrow-source reconciliation

Successful source-review run 36194717114 revalidated the original 27 narrow facts against exact historical SDK revision eec03e0fa3a2ee327eb4e3368b3f8458ac85e582. Four are also matched by the later atomic assessment; 23 require a separate present-version interpretation. The per-occurrence successor references the earlier source-review disposition and retains the frozen 38-page capture hash. This does not authorize import of generated DeepWiki pages or claim that any complete generated paragraph is correct. The new independently authored first-party SDK contracts remain outside the public wiki builder pending existing-owner approval.
