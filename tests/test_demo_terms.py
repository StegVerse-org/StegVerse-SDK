...
class DemoTermsTests(unittest.TestCase):
    def test_acceptance_binds_exact_current_terms(self) -> None:
        receipt = accept_demo_terms(participant_id="evaluator:example", signer_name="Example Evaluator", signer_capacity="self", accepted=True, electronic_signature="Example Evaluator", accepted_at="2026-08-12T15:00:00Z")
