...
def test_zip_and_tar_gz_verify_same_s_payload(tmp_path):
    ...
    assert zip_result["single_host_sovereignty"] == tar_result["single_host_sovereignty"]
    assert zip_result["physical_additional_machine_required"] is False
...
def test_tar_gz_ns_install_remains_not_activated(tmp_path):
    ...
    assert installed["third_party_runtime_infrastructure_required"] is False
