...
EXACT = {
    ...
    ("stegverse/manifest_contract.py", 69): "if declared_route_id != route_id:",
    ...
    ("stegverse/universal_entry_dispatch.py", 47): '"completed", "degraded", "unavailable", "failed_closed"',
    ("stegverse/security_posture_request.py", 9): '"SECURE", "HIGH", "HIGHEST"',
    ("stegverse/security_posture_request.py", 37): 'NONE_REQUEST_INPUT_ONLY',
    ...
    ("stegverse/ecosystem_chat_pipeline_http.py", 34): "status = 202 if accepted else 422",
