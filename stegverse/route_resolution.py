...
PUBLISHED_ROUTES: dict[str, dict[str, Any]] = {
    CANONICAL_PRODUCTION_ROUTE_ID: {
        ...
        "state_graph_adapter_binding": "stegverse.governance_ingress_runtime.external_manifest_to_public_request",
    ...
    ECOSYSTEM_DIAGNOSTIC_ROUTE_ID: {
        ...
        "sandbox_required": False,
        "external_consequence_enabled": False,
        "state_graph_adapter_binding": "stegverse.ecosystem_diagnostic_runtime.execute_manifest",
        "runtime_binding": "stegverse.manifest_state_transition_runtime.execute_manifest",
        "runtime_installed": True,
    },
