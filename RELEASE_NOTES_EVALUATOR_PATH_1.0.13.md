...
`v1.0.13` must resolve exactly to `16c99037a42e4d667b9df4a7a5efbaae9dd7184c`. Later source receipts and documentation commits do not silently move this candidate. A changed runtime/source proposition requires a new candidate, new source receipt, and new release-set identity.
